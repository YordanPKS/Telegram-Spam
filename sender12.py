...
photo2 = ['foto1.jpg','foto2.jpg']

photo3 = ['foto1.jpg','foto2.jpg','foto3.jpg']
...
def messagesender():
    ...
    print(Style.BRIGHT + Fore.YELLOW + 'Qué cuenta desea usar?\n\nEnter: ')
    ...
    def sedmrunal():
        ...
        if not client.is_user_authorized():
            try:
                ...
                client.sign_in(phone, input('Introduzca el código : '))
                print('')
    ...
    def sedmrunal():
        ...
        for line in mrunal :
            try:
                ...
                print(f"Unido correctamente {line}")
                time.sleep(10)
            except Exception as e:
                er += 1
                print(f"{e},{line}")
